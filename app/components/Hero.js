      ...
      <section className="py-16 px-6 bg-black/20">
        <div className="max-w-4xl mx-auto text-center">
          <blockquote className="text-2xl md:text-3xl italic text-gray-300 mb-4">
            &ldquo;I believe the strongest architects still think like engineers
            — building solutions that aren&rsquo;t just drawn, but delivered.
            It&rsquo;s where strategy meets code.&rdquo;
          </blockquote>
